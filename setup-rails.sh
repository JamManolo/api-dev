...
rails g migration add_latest_round_to_leagues latest_round:integer
...
# rails g migration add_columns_to_fixtures home_goals:integer \
#                                           away_goals:integer \
#                                           time_x:integer

# rails g migration modify_fixtures_column_type 
